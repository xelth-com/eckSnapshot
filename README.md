...
2.  **The Coder LLM (Claude Code, GLM Z.AI):** A model specialized in writing and modifying code. It takes the detailed instructions generated by the Architect and performs the hands-on coding tasks.
...
2.  **An AI Assistant CLI (at least one of the following is required):**
    ...
    *   **GLM Z.AI:** GLM Z.AI API access (`ZAI_API_KEY` env var) for cost-effective worker tasks.
